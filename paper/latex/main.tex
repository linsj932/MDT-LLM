%% ============================================================
%%  MDT-LLM: A Multidisciplinary Team-Based Multi-Agent LLM
%%  Framework with RAG for Evidence-Based Clinical Decision Support
%%
...
\title{MDT-LLM: A Multidisciplinary Team-Based Multi-Agent Large Language
Model Framework with Retrieval-Augmented Generation for
...
figures are released at \url{https://github.com/[org]/MDT-LLM}.
